...
import { authenticatedQuery, authenticationMutation } from "./helpers";
...
export const createFriendRequest = authenticationMutation({
...
export const updateStatus = authenticationMutation({
  args: {
    id: v.id("friends"),
...
export const mapwithUsers = async <
  K extends string,
